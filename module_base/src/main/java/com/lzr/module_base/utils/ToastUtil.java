...
//			toast.setGravity(Gravity.CENTER, 0, 0);
    ...
    public static void s(int resMsg) {
        if (null == toast) {
            toast = Toast.makeText(mContext, resMsg, Toast.LENGTH_SHORT);
//			toast.setGravity(Gravity.CENTER, 0, 0);
        } else {
...
//		if (mCToast==null) {
//			mCToast = new Toast(BaseApp.getInstance());
//			View view = View.inflate(BaseApp.getInstance(), R.layout.toast_layout, null);
//			mTvMsg=view.findViewById(R.id.toast_tvMsg);
//			mCToast.setGravity(Gravity.BOTTOM, 0, AppUtil.dip2px(100));
//			mCToast.setDuration(Toast.LENGTH_SHORT);
//			mCToast.setView(view);
//		}
//
//		mTvMsg.setText(msg);
//		mCToast.show();
